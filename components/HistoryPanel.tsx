...
>
  ...
  className="w-full max-w-5xl rounded-3xl border  border-white/10 bg-white/[0.04] backdrop-blur-xl p-6 sm:p-8 lg:p-10"
>
        ...
        <input
          ...
          className="flex-1 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-white outline-none focus:border-cyan-400 transition-all duration-300
focus:ring-2
focus:ring-cyan-500/30"
         ...
         <select
          ...
          className="rounded-2xl border border-white/10 bg-slate-900 px-4 py-3 text-white transition-all duration-300"
        >
         <option>All</option>
      ...
      🕘
          ...
          <div className="space-y-4">
            {filteredHistory.map((item) => (
                 <div
                   key={item.id}
                   className="mb-4 rounded-2xl border border-white/10 bg-white/5 p-5 transition hover:border-cyan-400 hover:bg-white/10 hover:-translate-y-1 transition-all duration-300"
                 >
                   ...
                   <div className="mt-5 flex gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-xl bg-cyan-600 px-4 py-2 text-sm font-medium text-white transition hover:scale-105 hover:bg-cyan-700 transition-all duration-300
hover:scale-105
active:scale-95"
                    >
                      <Copy size={16} />
                    ...
                    <button onClick={() => toggleFavorite(item.id)}
                      className={`flex items-center gap-2 rounded-xl px-4 py-2 text-sm font-medium text-white transition hover:scale-105 transition-all duration-300
hover:scale-105
active:scale-95 ${
                        item.favorite
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-xl bg-red-600 px-4 py-2 text-sm font-medium text-white transition hover:scale-105 hover:bg-red-700 transition-all duration-300
hover:scale-105
active:scale-95"
                    >
                      <Trash2 size={16} />
